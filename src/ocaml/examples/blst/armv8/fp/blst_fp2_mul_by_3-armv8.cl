...
ghost carry_old1@uint1 : carry_old1 = carry && carry_old1 = carry;

(* sbcs	xzr, x3, xzr                               #! PC = 0x274877979796 *)
sbcs carry dontcare x3 0@uint64 carry;

assert true && carry = carry_old1;
assume carry = carry_old1 && true;
...
assert true && carry * (1@1 - carry) = 0@1;
assume carry * (1 - carry) = 0 && true;
ghost carry_old2@uint1 : carry_old2 = carry && carry_old2 = carry;

(* sbcs	xzr, x3, xzr                               #! PC = 0x274877979500 *)
sbcs carry dontcare x3 0@uint64 carry;

assert true && carry = carry_old2;
assume carry = carry_old2 && true;
...
assert true && carry * (1@1 - carry) = 0@1;
assume carry * (1 - carry) = 0 && true;
ghost carry_old3@uint1 : carry_old3 = carry && carry_old3 = carry;

(* sbcs	xzr, x3, xzr                               #! PC = 0x274877979796 *)
sbcs carry dontcare x3 0@uint64 carry;

assert true && carry = carry_old3;
assume carry = carry_old3 && true;
...
assert true && carry * (1@1 - carry) = 0@1;
assume carry * (1 - carry) = 0 && true;
ghost carry_old4@uint1 : carry_old4 = carry && carry_old4 = carry;

(* sbcs	xzr, x3, xzr                               #! PC = 0x274877979500 *)
sbcs carry dontcare x3 0@uint64 carry;

assert true && carry = carry_old4;
assume carry = carry_old4 && true;
