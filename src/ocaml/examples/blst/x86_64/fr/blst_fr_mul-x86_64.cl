...
#callq  0x555555567980 <mulx_mont_sparse_256>   #! 0x93824992297901 = 0x93824992297901;
...
umull r11 rax r14 rdx;
(* #callq  0x555555567a60 <__mulx_mont_sparse_256> #! PC = 0x93824992311732 *)
#callq  0x555555567a60 <__mulx_mont_sparse_256> #! 0x93824992311732 = 0x93824992311732;
...
assume eqmod (limbs 64 [0, 0, 0, 0, q0, q1, q2, q3, q4])
             ((limbs 64 [x0, x1, x2, x3]) * (limbs 64 [y0, y1, y2, y3]))
             (limbs 64 [m0, m1, m2, m3]) && true;
...
#repz retq                                      #! 0x93824992312772 = 0x93824992312772;
(* #retq                                           #! PC = 0x93824992297910 *)
#retq                                           #! 0x93824992297910 = 0x93824992297910;
...
cut and [
   eqmod (limbs 64 [0, 0, 0, 0, q0, q1, q2, q3, q4])
         ((limbs 64 [x0, x1, x2, x3]) * (limbs 64 [y0, y1, y2, y3]))
