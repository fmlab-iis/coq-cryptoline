...
proc main(
  ...
  uint128 y0, uint128 y1, uint128 y2, uint128 y3,
  uint128 z0, uint128 z1, uint128 z2, uint128 z3,
  uint128 x_in2_0, uint128 x_in2_16, uint128 x_in2_32, uint128 x_in2_48,
  uint128 y_in5_0, uint128 y_in5_16, uint128 y_in5_32, uint128 y_in5_48,
  uint128 z_in3_0, uint128 z_in3_16, uint128 z_in3_32, uint128 z_in3_48,
  uint128 delta_0, uint128 delta_16, uint128 delta_32, uint128 delta_48,
  uint128 gamma_0, uint128 gamma_16, uint128 gamma_32, uint128 gamma_48,
  uint128 beta_0, uint128 beta_16, uint128 beta_32, uint128 beta_48,
  uint128 alpha_0, uint128 alpha_16, uint128 alpha_32, uint128 alpha_48,
  uint64 small1_0, uint64 small1_8, uint64 small1_16, uint64 small1_24,
  uint64 small2_0, uint64 small2_8, uint64 small2_16, uint64 small2_24
) =
{
  and [
    x_in2_0 = x0, x_in2_16 = x1, x_in2_32 = x2, x_in2_48 = x3,
    y_in5_0 = y0, y_in5_16 = y1, y_in5_32 = y2, y_in5_48 = y3,
    z_in3_0 = z0, z_in3_16 = z1, z_in3_32 = z2, z_in3_48 = z3,

    (* delta = z^2 *)
    (limbs 64 [delta_0, delta_16, delta_32, delta_48])
    =
    ((limbs 64 [z0, z1, z2, z3]) ** 2)
    (mod (limbs 64 [18446744073709551615, 4294967295, 0, 18446744069414584321]))
    ,
    (* gamma = y^2 *)
    (limbs 64 [gamma_0, gamma_16, gamma_32, gamma_48])
    =
    ((limbs 64 [y0, y1, y2, y3]) ** 2)
    (mod (limbs 64 [18446744073709551615, 4294967295, 0, 18446744069414584321]))
    ,
    (* beta = x * gamma *)
    (limbs 64 [beta_0, beta_16, beta_32, beta_48])
    =
    ((limbs 64 [x0, x1, x2, x3]) * (limbs 64 [gamma_0, gamma_16, gamma_32, gamma_48]))
    (mod (limbs 64 [18446744073709551615, 4294967295, 0, 18446744069414584321]))
    ,
    (* alpha = 3 * (x - delta) * (x + delta) *)
    (limbs 64 [alpha_0, alpha_16, alpha_32, alpha_48])
    =
    (
      3 *
      ((limbs 64 [x0, x1, x2, x3]) - (limbs 64 [delta_0, delta_16, delta_32, delta_48])) *
      ((limbs 64 [x0, x1, x2, x3]) + (limbs 64 [delta_0, delta_16, delta_32, delta_48]))
    )
    (mod (limbs 64 [18446744073709551615, 4294967295, 0, 18446744069414584321]))
    ,
